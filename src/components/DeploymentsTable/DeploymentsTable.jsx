...
const propTypes = {
  data: React.PropTypes.arrayOf(React.PropTypes.shape({
    ...
    model: React.PropTypes.shape({
      ...
      runtimeEnvironment: React.PropTypes.string,
    })
  }))
};
        ...
        <table style={{width: '100%'}}>
          <thead className={styles['table-header']}>
            <tr>
              ...
              <th className={styles['model-runtime']}><span>MODEL RUNTIME</span></th>
            </tr>
          </thead>
          <tbody>
            {this.props.data.map(function (entry) {
              return (
                <tr
                  ...
                  <td className={styles['model-runtime']}>{entry.model.runtimeEnvironment}</td>
                </tr>
              );
            })}
          </tbody>
